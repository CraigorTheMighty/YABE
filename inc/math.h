...
#ifndef MATH_INLINE_DEF
#define MATH_INLINE_DEF 
#endif
...
#define M_2PI_F			6.283185307179586476925286766559f
#define M_SQRT2			1.4142135623730950488016887242097
#define M_SQRT2_F		1.4142135623730950488016887242097f
#define M_SQRT2_DIV2	0.70710678118654752440084436210485
#define M_SQRT2_DIV2_F	0.70710678118654752440084436210485f
#define M_SQRT3			1.7320508075688772935274463415059
#define M_SQRT3_F		1.7320508075688772935274463415059f
#define M_SQRT3_DIV2	0.86602540378443864676372317075294
#define M_SQRT3_DIV2_F	0.86602540378443864676372317075294f
#define M_GOLDEN		1.618033988749894848204586834365638
#define M_GOLDEN_F		1.618033988749894848204586834365638f
#define M_INV_GOLDEN	0.618033988749894848204586834365638
#define M_INV_GOLDEN_F	0.618033988749894848204586834365638f



MATH_INLINE_DEF uint8_t Math_SignExtendu8(uint8_t x, int bits);
MATH_INLINE_DEF uint16_t Math_SignExtendu16(uint16_t x, int bits);
MATH_INLINE_DEF uint32_t Math_SignExtendu32(uint32_t x, int bits);
MATH_INLINE_DEF uint64_t Math_SignExtendu64(uint64_t x, int bits);

MATH_INLINE_DEF int8_t Math_SignExtendi8(int8_t x, int bits);
MATH_INLINE_DEF int16_t Math_SignExtendi16(int16_t x, int bits);
MATH_INLINE_DEF int32_t Math_SignExtendi32(int32_t x, int bits);
MATH_INLINE_DEF int64_t Math_SignExtendi64(int64_t x, int bits);

MATH_INLINE_DEF uint8_t Math_CeilPow2u8(uint8_t x);
MATH_INLINE_DEF uint16_t Math_CeilPow2u16(uint16_t x);
MATH_INLINE_DEF uint32_t Math_CeilPow2u32(uint32_t x);
MATH_INLINE_DEF uint64_t Math_CeilPow2u64(uint64_t x);

MATH_INLINE_DEF uint8_t Math_FloorPow2u8(uint8_t x);
MATH_INLINE_DEF uint16_t Math_FloorPow2u16(uint16_t x);
MATH_INLINE_DEF uint32_t Math_FloorPow2u32(uint32_t x);
MATH_INLINE_DEF uint64_t Math_FloorPow2u64(uint64_t x);

MATH_INLINE_DEF int Math_PopCnt8(uint8_t x);
MATH_INLINE_DEF int Math_PopCnt16(uint16_t x);
MATH_INLINE_DEF int Math_PopCnt32(uint32_t x);
MATH_INLINE_DEF int Math_PopCnt64(uint64_t x);

MATH_INLINE_DEF int Math_LZCnt8(uint8_t x);
MATH_INLINE_DEF int Math_LZCnt16(uint16_t x);
MATH_INLINE_DEF int Math_LZCnt32(uint32_t x);
MATH_INLINE_DEF int Math_LZCnt64(uint64_t x);

MATH_INLINE_DEF int Math_FloorLog2u8(uint8_t x);
MATH_INLINE_DEF int Math_FloorLog2u16(uint16_t x);
MATH_INLINE_DEF int Math_FloorLog2u32(uint32_t x);
MATH_INLINE_DEF int Math_FloorLog2u64(uint64_t x);

MATH_INLINE_DEF int Math_CeilLog2u8(uint8_t x);
MATH_INLINE_DEF int Math_CeilLog2u16(uint16_t x);
MATH_INLINE_DEF int Math_CeilLog2u32(uint32_t x);
MATH_INLINE_DEF int Math_CeilLog2u64(uint64_t x);

MATH_INLINE_DEF uint64_t	Math_RotL64(uint64_t x, int shift);
MATH_INLINE_DEF uint32_t	Math_RotL32(uint32_t x, int shift);
MATH_INLINE_DEF uint16_t	Math_RotL16(uint16_t x, int shift);
MATH_INLINE_DEF uint8_t		Math_RotL8(uint8_t x, int shift);

MATH_INLINE_DEF double Math_Minf64(double x, double y);
MATH_INLINE_DEF double Math_Maxf64(double x, double y);
MATH_INLINE_DEF double Math_Clampf64(double x, double min, double max);
MATH_INLINE_DEF double Math_Lerpf64(double a, double b, double t);
MATH_INLINE_DEF float Math_Minf32(float x, float y);
MATH_INLINE_DEF float Math_Maxf32(float x, float y);
MATH_INLINE_DEF float Math_Clampf32(float x, float min, float max);
MATH_INLINE_DEF float Math_Lerpf32(float a, float b, float t);
MATH_INLINE_DEF int64_t Math_Mini64(int64_t x, int64_t y);
MATH_INLINE_DEF int64_t Math_Maxi64(int64_t x, int64_t y);
MATH_INLINE_DEF int64_t Math_Clampi64(int64_t x, int64_t min, int64_t max);
MATH_INLINE_DEF int32_t Math_Mini32(int32_t x, int32_t y);
MATH_INLINE_DEF int32_t Math_Maxi32(int32_t x, int32_t y);
MATH_INLINE_DEF int32_t Math_Clampi32(int32_t x, int32_t min, int32_t max);
MATH_INLINE_DEF int16_t Math_Mini16(int16_t x, int16_t y);
MATH_INLINE_DEF int16_t Math_Maxi16(int16_t x, int16_t y);
MATH_INLINE_DEF int16_t Math_Clampi16(int16_t x, int16_t min, int16_t max);
MATH_INLINE_DEF int8_t Math_Mini8(int8_t x, int8_t y);
MATH_INLINE_DEF int8_t Math_Maxi8(int8_t x, int8_t y);
MATH_INLINE_DEF int8_t Math_Clampi8(int8_t x, int8_t min, int8_t max);
MATH_INLINE_DEF uint64_t Math_Minu64(uint64_t x, uint64_t y);
MATH_INLINE_DEF uint64_t Math_Maxu64(uint64_t x, uint64_t y);
MATH_INLINE_DEF uint64_t Math_Clampu64(uint64_t x, uint64_t min, uint64_t max);
MATH_INLINE_DEF uint32_t Math_Minu32(uint32_t x, uint32_t y);
MATH_INLINE_DEF uint32_t Math_Maxu32(uint32_t x, uint32_t y);
MATH_INLINE_DEF uint32_t Math_Clampu32(uint32_t x, uint32_t min, uint32_t max);
MATH_INLINE_DEF uint16_t Math_Minu16(uint16_t x, uint16_t y);
MATH_INLINE_DEF uint16_t Math_Maxu16(uint16_t x, uint16_t y);
MATH_INLINE_DEF uint16_t Math_Clampu16(uint16_t x, uint16_t min, uint16_t max);
MATH_INLINE_DEF uint8_t Math_Minu8(uint8_t x, uint8_t y);
MATH_INLINE_DEF uint8_t Math_Maxu8(uint8_t x, uint8_t y);
MATH_INLINE_DEF uint8_t Math_Clampu8(uint8_t x, uint8_t min, uint8_t max);

MATH_INLINE_DEF uint64_t Math_Binomial(int n, int k);

MATH_INLINE_DEF double Math_GeometricLimitf64(double base, int n);
MATH_INLINE_DEF float Math_GeometricLimitf32(float base, int n);

MATH_INLINE_DEF _Fcomplex	Math_ComplexAddF(_Fcomplex x, _Fcomplex y);
MATH_INLINE_DEF _Fcomplex	Math_ComplexSubF(_Fcomplex x, _Fcomplex y);
MATH_INLINE_DEF _Fcomplex	Math_ComplexMulF(_Fcomplex x, _Fcomplex y);
MATH_INLINE_DEF _Fcomplex	Math_ComplexMulRealF(float x, _Fcomplex y);
MATH_INLINE_DEF _Fcomplex	Math_ComplexFromRealF(float x);
MATH_INLINE_DEF float		Math_ComplexAbsF(_Fcomplex x);
MATH_INLINE_DEF float		Math_ComplexAbsSqF(_Fcomplex x);
MATH_INLINE_DEF _Fcomplex	Math_ComplexCbrtF(_Fcomplex x, int root);

MATH_INLINE_DEF int Math_FFT_Frequency(_Fcomplex *vector, size_t N);
MATH_INLINE_DEF int Math_IFFT_Frequency(_Fcomplex *vector, size_t N);
MATH_INLINE_DEF int Math_FFT_FrequencyR(_Fcomplex *vector_out, float *vector_in, size_t N);
MATH_INLINE_DEF int Math_FFT_FrequencyR2D(_Fcomplex *vector_out, float *vector_in, size_t N, int max_threads);
MATH_INLINE_DEF int Math_IFFT_Frequency2D(_Fcomplex *vector, size_t N, int max_threads);

MATH_INLINE_DEF void Math_PolynomialDeg4Solvef32(float *real_roots, _Fcomplex *complex_roots, int *num_real_roots, int *num_complex_roots, float a, float b, float c, float d, float e, float f);
MATH_INLINE_DEF void Math_PolynomialDeg3Solvef32(float *real_roots, _Fcomplex *complex_roots, int *num_real_roots, int *num_complex_roots, float a, float b, float c, float d, float e);
MATH_INLINE_DEF void Math_PolynomialDeg2Solvef32(float *real_roots, _Fcomplex *complex_roots, int *num_real_roots, int *num_complex_roots, float a, float b, float c, float d);
MATH_INLINE_DEF void Math_PolynomialDeg2Solvef64(double *real_roots, _Dcomplex *complex_roots, int *num_real_roots, int *num_complex_roots, double a, double b, double c, double d);
MATH_INLINE_DEF float Math_PolynomialDeg1Solvef32(float a, float b, float c);
MATH_INLINE_DEF double Math_PolynomialDeg1Solvef64(double a, double b, double c);

MATH_INLINE_DEF uint64_t Math_Factorialu64(int n);

#ifdef MATH_INLINE_MATH
...
MATH_INLINE_DEF double Math_IncompleteBeta(double x, double a, double b) 
{
	if (x < 0.0 || x > 1.0)
		return -1.0;
